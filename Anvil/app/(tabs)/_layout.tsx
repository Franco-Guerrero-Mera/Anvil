...
const GroupIcon = ({ size = 28, color = "#FF960E" }) => (
...
const PersonaIcon = ({ size = 28, color = "#FF960E" }) => (
...
const CustomTabBar = ({
  ...
  const popupStyle = (
    ...
    useAnimatedStyle(() => ({
      transform: [
        { translateX: x.value },
        { translateY: y.value },
        { scale: y.value === 0 ? withTiming(0) : 1 },
      ],
      opacity: blurOpacity.value,
    }));
  ...
  return (
    <>
      ...
      {/* Popup buttons */}
      <Animated.View style={[styles.popupIcon, popupStyle(icon1X, icon1Y)]}>
        <TouchableOpacity onPress={() => {
          toggleMenu();
          navigation.navigate("persona");
        }}>
          <LinearGradient colors={["#FF960E", "#FF1601"]} style={styles.popupCircle}>
            <PersonaIcon size={26} color="white" />
          </LinearGradient>
        </TouchableOpacity>
      </Animated.View>

      <Animated.View style={[styles.popupIcon, popupStyle(icon2X, icon2Y)]}>
        <TouchableOpacity onPress={() => {
          toggleMenu();
      ...
      <Animated.View style={[styles.popupIcon, popupStyle(icon3X, icon3Y)]}>
        <TouchableOpacity onPress={() => {
          toggleMenu();
      ...
      <View style={styles.tabBar}>
        <TabIcon
          label="Home"
          icon={<Ionicons name="home" size={36} color="#FF960E" />}
          onPress={() => navigation.navigate("home")}
        />
        <TabIcon
          label="Bobert"
          icon={<Ionicons name="chatbubbles" size={36} color="#FF960E" />}
       ...
       <View style={styles.spacer} />
        ...
        <TabIcon
          label="Self-coaching"
          icon={<Ionicons name="book" size={35} color="#FF960E" />}
          onPress={() => navigation.navigate("journal")}
        />
        <TabIcon
          label="Message"
          icon={<GroupIcon size={36} color="#FF960E" />}
